...
def cargame():
    ...
    carimg = pygame.image.load("CarRacing/car1.jpg")  #loading images
    grass = pygame.image.load("CarRacing/grass.jpg")
    yellow_strip = pygame.image.load("CarRacing/yellow_strip.jpg")
    strip = pygame.image.load("CarRacing/strip.jpg")
    intro_image = pygame.image.load("CarRacing/intro.jpg")
    instruction_background = pygame.image.load("CarRacing/background.jpg")
    instruction_background2 = pygame.image.load("CarRacing/background2.jpg")
    ...
    def obstacle(obs_x,obs_y,obs):  #definig function for obstacle
        if obs == 0:
            obs_pic = pygame.image.load("CarRacing/car2.jpg")
        elif obs == 1:
            obs_pic = pygame.image.load("CarRacing/car3.jpg")
        elif obs == 2:
            obs_pic = pygame.image.load("CarRacing/car4.jpg")
        elif obs == 3:
            obs_pic = pygame.image.load("CarRacing/car5.jpg")
        elif obs == 4:
            obs_pic = pygame.image.load("CarRacing/car6.jpg")
        elif obs == 5:
            obs_pic = pygame.image.load("CarRacing/car7.jpg")
